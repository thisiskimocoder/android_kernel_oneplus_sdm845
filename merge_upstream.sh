...
# Wi-Fi
git subtree add --prefix=drivers/staging/fw-api fw-api $1
git subtree add --prefix=drivers/staging/qca-wifi-host-cmn qca-wifi-host-cmn $1
git subtree add --prefix=drivers/staging/qcacld-3.0 qcacld-3.0 $1
